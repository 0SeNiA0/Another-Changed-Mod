...
public class EntityTypeTagProvider extends EntityTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider p_255894_) {
        tag(TestMod.TRANSFURRABLE_TAG).add(EntityType.HUSK,EntityType.VILLAGER,EntityType.ZOMBIE,EntityType.ZOMBIE_VILLAGER).addTags(EntityTypeTags.RAIDERS,EntityTypeTags.SKELETONS);
    }
}