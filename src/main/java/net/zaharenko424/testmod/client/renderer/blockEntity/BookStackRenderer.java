...
public class BookStackRenderer implements BlockEntityRenderer<BookStackEntity> {
    ...
    private static final ResourceLocation BOOK_0 = TestMod.textureLoc("block/book_stack/book_0");
    private static final ResourceLocation BOOK_1 = TestMod.textureLoc("block/book_stack/book_1");
    private static final ResourceLocation BOOK_2 = TestMod.textureLoc("block/book_stack/book_2");
    private static final ResourceLocation BOOK_3 = TestMod.textureLoc("block/book_stack/book_3");
