...
import net.zaharenko424.testmod.client.model.layers.ArmorLayer;
import net.zaharenko424.testmod.client.model.layers.SpinAttackEffect;
...
public class LatexEntityRenderer<E extends LivingEntity> extends LivingEntityRenderer<E, AbstractLatexEntityModel<E>> {
    ...
    public LatexEntityRenderer(EntityRendererProvider.Context p_174304_) {
        this(p_174304_, new DummyModel<>(p_174304_.bakeLayer(new ModelLayerLocation(new ResourceLocation(TestMod.MODID,"dummy"),"main"))));
