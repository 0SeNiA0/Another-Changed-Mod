...
public final class TransfurRegistry {
    ...
    public static final DeferredHolder<AbstractTransfurType, LatexWolf> WHITE_LATEX_WOLF_F_TF = TRANSFUR_TYPES.register("white_latex_wolf_female", ()-> new LatexWolf(resourceLocation("white_latex_wolf_female"),false));
