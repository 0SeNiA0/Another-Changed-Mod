...
public class ItemTagProvider extends ItemTagsProvider {
    ...
    public ItemTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> holderLookup, CompletableFuture<TagLookup<Block>> tagLookup, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, holderLookup, tagLookup, AChanged.MODID, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.@NotNull Provider p_256380_) {
        ...
        tag(ItemTags.LOGS_THAT_BURN).add(ORANGE_TREE_LOG_ITEM.get(), ORANGE_WOOD_ITEM.get(), STRIPPED_ORANGE_LOG_ITEM.get(), STRIPPED_ORANGE_WOOD_ITEM.get());
