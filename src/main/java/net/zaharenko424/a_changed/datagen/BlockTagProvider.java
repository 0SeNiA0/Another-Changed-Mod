...
public class BlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider p_256380_) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(AIR_CONDITIONER.get(), BIG_LAB_DOOR.get(), BIG_LIBRARY_DOOR.get(),
                ...
                LAB_BLOCK.get(), LAB_SLAB.get(), LAB_STAIRS.get(), LAB_DOOR.get(), LAB_TILE.get(), LAB_TILE_SLAB.get(),
                ...
                STRIPED_ORANGE_LAB_BLOCK.get(), TABLE.get(), VENT_DUCT.get(), VENT_HATCH.get(), VENT_WALL.get(), YELLOW_LAB_BLOCK.get(),
