...
public class BlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider p_256380_) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(AIR_CONDITIONER.get(), BIG_LAB_DOOR.get(), BIG_LAB_LAMP.get(), BIG_LIBRARY_DOOR.get(),
                ...
                DERELICT_LATEX_PURIFIER.get(), DNA_EXTRACTOR.get(), GAS_TANK.get(), GENERATOR.get(), GREEN_CRYSTAL.get(),
                HAZARD_BLOCK.get(), HAZARD_SLAB.get(), HAZARD_STAIRS.get(), HAZARD_LAB_BLOCK.get(), IV_RACK.get(), KEYPAD.get(),
                LAB_BLOCK.get(), LAB_SLAB.get(), LAB_STAIRS.get(), LAB_DOOR.get(), LAB_LAMP.get(), LAB_TILE.get(), LAB_TILE_SLAB.get(),
                LAB_TILE_STAIRS.get(), LASER_EMITTER.get(), LATEX_CONTAINER.get(), LATEX_ENCODER.get(), LATEX_PURIFIER.get(),
                LIBRARY_DOOR.get(), MAINTENANCE_DOOR.get(), METAL_BOX.get(), METAL_CAN.get(), ORANGE_LAB_BLOCK.get(),
                ORANGE_LAB_SLAB.get(), ORANGE_LAB_STAIRS.get(), PIPE.get(), SCANNER.get(), SMART_SEWAGE_SYSTEM.get(),
                STRIPED_ORANGE_LAB_BLOCK.get(), TABLE.get(), TV_SCREEN.get(), VENT_DUCT.get(), VENT_HATCH.get(), VENT_WALL.get(),
                YELLOW_LAB_BLOCK.get(), YELLOW_LAB_SLAB.get(), YELLOW_LAB_STAIRS.get());
