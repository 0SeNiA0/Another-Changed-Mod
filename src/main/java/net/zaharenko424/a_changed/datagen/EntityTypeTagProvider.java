...
public class EntityTypeTagProvider extends EntityTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider p_255894_) {
        tag(AChangedTags.Entity.SEWAGE_SYSTEM_CONSUMABLE).add(EntityRegistry.MILK_PUDDING.get(), EntityType.SLIME);

        tag(AChangedTags.Entity.TRANSFURRABLE_TAG).add(EntityType.PLAYER, EntityType.PIGLIN, EntityType.PIGLIN_BRUTE, EntityType.VILLAGER,
