...
public class ClientboundGrabUpdatePacket implements SimpleMessage {
    ...
    public ClientboundGrabUpdatePacket(int targetId, int grabbedBy, GrabMode mode, boolean wantsToBeGrabbed){
    ...
    public ClientboundGrabUpdatePacket(@NotNull FriendlyByteBuf buf){
