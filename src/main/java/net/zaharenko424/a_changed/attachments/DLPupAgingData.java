...
public class DLPupAgingData implements AbilityData {
    ...
    public DLPupAgingData(@NotNull IAttachmentHolder holder){
    ...
    public static class Serializer implements IAttachmentSerializer<CompoundTag, DLPupAgingData> {

        @Override
        public @NotNull DLPupAgingData read(@NotNull IAttachmentHolder holder, @NotNull CompoundTag tag, HolderLookup.@NotNull Provider provider) {
            DLPupAgingData data = new DLPupAgingData(holder);
        ...
        @Override
        public @Nullable CompoundTag write(@NotNull DLPupAgingData attachment, HolderLookup.@NotNull Provider provider) {
            if(attachment.age == 0 || attachment.age >= DLPupAgingData.turnAfter) return null;
