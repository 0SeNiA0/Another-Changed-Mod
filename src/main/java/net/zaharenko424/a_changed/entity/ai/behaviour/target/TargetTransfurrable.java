...
public class TargetTransfurrable<E extends Mob> extends ExtendedBehaviour<E> {
     ...
     * @return this
     */
    public TargetTransfurrable<E> attackablePredicate(Predicate<LivingEntity> predicate) {
     ...
     * @return this
     */
    public TargetTransfurrable<E> useMemory(MemoryModuleType<? extends LivingEntity> memory) {
     ...
     * @return this
     */
    public TargetTransfurrable<E> alertAlliesWhen(BiPredicate<E, Entity> predicate) {
     ...
     * @return this
     */
    public TargetTransfurrable<E> isAllyIf(BiPredicate<E, LivingEntity> predicate) {
    ...
    protected boolean checkExtraStartConditions(@NotNull ServerLevel level, E owner) {
        ...
        if(this.toTarget == null || !canAttackPredicate.test(toTarget)) {
    ...
    protected void start(E entity) {
        ...
        BrainUtils.setMemory(entity, MemoryTypeRegistry.TRYING_TO_TRANSFUR.get(), true);
