...
public class PneumaticSyringeRifleScreen extends AbstractContainerScreen<PneumaticSyringeRifleMenu> {

    private static final ResourceLocation TEXTURE = AChanged.textureLoc("gui/syringe_rifle");

    public PneumaticSyringeRifleScreen(PneumaticSyringeRifleMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
