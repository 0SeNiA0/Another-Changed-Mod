...
public class LatexEncoderRenderer implements BlockEntityRenderer<LatexEncoderEntity> {
    ...
    public static @NotNull ModelDefinition bodyLayer(){
        ...
        root.addOrReplaceChild("latexBase", GroupBuilder.create()
                .addBox(3.5f, 13f, 3.5f, 1f, 4f, 1f, new CubeUV().south(1f, 4f, 0f, 0f).north(1f, 4f, 0f, 0f).west(1f, 4f, 0f, 0f).up(0f, 0f, 1f, 1f).down(0f, 0f, 1f, 1f).east(1f, 4f, 0f, 0f)));
        GroupDefinition dna = root.addOrReplaceChild("dna", GroupBuilder.create());
        dna.addOrReplaceChild("dna0", GroupBuilder.create()
                .addBox(-1.4f, 13f, 3.1f, 1.8f, 3f, 1.8f, new CubeUV().south(2f, 6f, 0f, 3f).north(2f, 3f, 0f, 0f).west(4f, 6f, 2f, 3f).up(10f, 2f, 8f, 0f).down(10f, 2f, 8f, 4f).east(4f, 3f, 2f, 0f))
                .addBox(-0.9f, 13f, 3.6f, 0.8f, 2.5f, 0.8f, new CubeUV().south(5f, 11.5f, 4f, 9f).north(3f, 11.5f, 2f, 9f).west(6f, 11.5f, 5f, 9f).up(1f, 12f, 0f, 11f).down(12f, 0f, 11f, 1f).east(4f, 11.5f, 3f, 9f)));
        dna.addOrReplaceChild("dna1", GroupBuilder.create()
                .addBox(-3.4f, 13f, 3.1f, 1.8f, 3f, 1.8f, new CubeUV().south(2f, 9f, 0f, 6f).north(6f, 3f, 4f, 0f).west(8f, 3f, 6f, 0f).up(10f, 6f, 8f, 4f).down(10f, 6f, 8f, 8f).east(6f, 6f, 4f, 3f))
                .addBox(-2.9f, 13f, 3.6f, 0.8f, 2.5f, 0.8f, new CubeUV().south(11f, 2.5f, 10f, 0f).north(7f, 11.5f, 6f, 9f).west(11f, 5.5f, 10f, 3f).up(2f, 12f, 1f, 11f).down(12f, 1f, 11f, 2f).east(8f, 11.5f, 7f, 9f)));
        dna.addOrReplaceChild("dna2", GroupBuilder.create()
                .addBox(-5.4f, 13f, 3.1f, 1.8f, 3f, 1.8f, new CubeUV().south(6f, 9f, 4f, 6f).north(4f, 9f, 2f, 6f).west(8f, 9f, 6f, 6f).up(10f, 10f, 8f, 8f).down(2f, 9f, 0f, 11f).east(8f, 6f, 6f, 3f))
                .addBox(-4.9f, 13f, 3.6f, 0.8f, 2.5f, 0.8f, new CubeUV().south(10f, 12.5f, 9f, 10f).north(11f, 8.5f, 10f, 6f).west(11f, 11.5f, 10f, 9f).up(12f, 3f, 11f, 2f).down(12f, 3f, 11f, 4f).east(9f, 12.5f, 8f, 10f)));
