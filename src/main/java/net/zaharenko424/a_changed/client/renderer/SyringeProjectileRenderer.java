...
public class SyringeProjectileRenderer extends EntityRenderer<SyringeProjectile> {
    ...
    public static @NotNull ModelDefinition bodyLayer(){
        ...
        groupDefinition.addOrReplaceChild("root", GroupBuilder.create()
                .addBox(-0.9f, 7f, -0.9f, 1.8f, 5.5f, 1.8f, new UV().west(2f, 12f, 0f, 6f).north(2f, 6f, 0f, 0f).east(4f, 6f, 2f, 0f).down(8f, 0f, 6f, 2f).south(6f, 6f, 4f, 0f))
                .addBox(-1.1f, 12.5f, -1.1f, 2.2f, 0.5f, 2.2f, new UV().west(12f, 10f, 10f, 9f).north(12f, 7f, 10f, 6f).east(12f, 8f, 10f, 7f).down(10f, 6f, 8f, 8f).up(10f, 6f, 8f, 4f).south(12f, 9f, 10f, 8f))
                .addBox(-0.6f, 12f, -0.6f, 1.2f, 0.5f, 1.2f, new UV().west(5f, 12f, 4f, 11f).north(12f, 3f, 11f, 2f).east(4f, 12f, 3f, 11f).down(7f, 11f, 6f, 12f).up(6f, 12f, 5f, 11f).south(12f, 4f, 11f, 3f))
                .addBox(-0.6f, 7.5f, -0.6f, 1.2f, 4f, 1.2f, new UV().west(3f, 14f, 2f, 10f).north(9f, 12f, 8f, 8f).east(10f, 12f, 9f, 8f).down(11f, 11f, 10f, 12f).up(8f, 12f, 7f, 11f).south(11f, 4f, 10f, 0f))
                .addBox(-0.3f, 3f, -0.3f, 0.6f, 4f, 0.6f, new UV().west(5f, 10f, 4f, 6f).north(3f, 10f, 2f, 6f).east(7f, 6f, 6f, 2f).down(11f, 10f, 10f, 11f).up(8f, 11f, 7f, 10f).south(4f, 10f, 3f, 6f))
                .addBox(-0.9f, 16f, -0.9f, 1.8f, 0.5f, 1.8f, new UV().west(12f, 6f, 10f, 5f).north(5f, 11f, 3f, 10f).east(12f, 5f, 10f, 4f).down(10f, 2f, 8f, 4f).up(10f, 2f, 8f, 0f).south(7f, 11f, 5f, 10f))
                .addBox(-0.2f, 12f, -0.2f, 0.4f, 4f, 0.4f, new UV().west(8f, 10f, 7f, 6f).north(6f, 10f, 5f, 6f).east(7f, 10f, 6f, 6f).down(12f, 1f, 11f, 2f).up(12f, 1f, 11f, 0f).south(8f, 6f, 7f, 2f)), PartPose.offsetAndRotation(9f, 0f, 0f, 0f, 0f, 1.5708f));
