...
import net.zaharenko424.a_changed.client.cmrs.gui.GuiMeshGenerator;
import net.zaharenko424.a_changed.util.Consumer4;
...
public class RadialButton extends Widget {
    ...
    public static final int defInsideColor = FastColor.ARGB32.color(196, Color.GRAY.getRGB());
