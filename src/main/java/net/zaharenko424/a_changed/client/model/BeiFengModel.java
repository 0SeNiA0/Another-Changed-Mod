...
public class BeiFengModel<E extends LivingEntity> extends UniversalCustomModel<E> {
    ...
    public BeiFengModel() {
        super(ModelDefinitionCache.getInstance().bake(bodyLayer),
                ...
                List.of(new CutOut(0), new VanillaTexArmor(ArmorItem.Type.HELMET), new VanillaTexArmor(ArmorItem.Type.CHESTPLATE), new VanillaTexArmor(ArmorItem.Type.LEGGINGS), new VanillaTexArmor(ArmorItem.Type.BOOTS),
                        new OpaqueColor(ModelPropertyKeys.RIGHT_SCLERA, -1), new OpaqueColor(ModelPropertyKeys.RIGHT_IRIS, -6062), new OpaqueColor(ModelPropertyKeys.LEFT_SCLERA, -1), new OpaqueColor(ModelPropertyKeys.LEFT_IRIS, -6062)),
    ...
    public static ModelDefinition model(){
        ...
        GroupDefinition head = root.addOrReplaceChild("head", GroupBuilder.create()
                .addBox(-4, 0, -4, 8, 8, 8, new CubeUV().down(26, 29, 18, 37).north(26, 29, 18, 21).up(34, 32, 26, 24).west(34, 24, 26, 16).east(18, 30, 10, 22).south(34, 16, 26, 8))
        ...
        right_ear.addOrReplaceChild("ear", GroupBuilder.create()
                .addBox(-1, -2, -1, 2, 9, 5, new CubeUV().down(14, 50, 12, 55).north(22, 55, 20, 46).up(6, 34, 4, 29).west(43, 9, 38, 0).east(22, 46, 17, 37).south(48, 44, 46, 35)), PartPose.rotation(0.7295f, 0.3578f, -0.1745f));
        right_ear.addOrReplaceChild("ear_inner", GroupBuilder.create()
                .addBox(-1, 2.2f, -5.8f, 2, 1, 8, new Vector3f(-0.01f), new CubeUV().down(12, 50, 10, 58).north(54, 45, 52, 44).up(10, 58, 8, 50).west(60, 33, 52, 32).east(60, 32, 52, 31).south(54, 46, 52, 45)), PartPose.rotation(1.7331f, 0.3578f, -0.1745f));
        ...
        left_ear.addOrReplaceChild("ear_i0", GroupBuilder.create()
                .addBox(-1, -2, -1, 2, 9, 5, new CubeUV().down(52, 30, 50, 35).north(48, 53, 46, 44).up(16, 55, 14, 50).west(43, 27, 38, 18).east(43, 18, 38, 9).south(49, 22, 47, 13)), PartPose.rotation(0.7295f, -0.3578f, 0.1745f));
        left_ear.addOrReplaceChild("ear_inner_i0", GroupBuilder.create()
                .addBox(-1, 2.2f, -5.8f, 2, 1, 8, new Vector3f(-0.01f), new CubeUV().down(46, 49, 44, 57).north(54, 43, 52, 42).up(44, 57, 42, 49).west(60, 31, 52, 30).east(16, 5, 8, 4).south(54, 44, 52, 43)), PartPose.rotation(1.7331f, -0.3578f, 0.1745f));
        head.addOrReplaceChild("maw", GroupBuilder.create()
                .addBox(-2, -1, -2, 4, 2, 2, new CubeUV().down(34, 52, 30, 54).north(56, 12, 52, 10).up(30, 54, 26, 52).west(54, 35, 52, 33).east(49, 24, 47, 22)), PartPose.offset(0, 2, -4));
        head.addOrReplaceChild("maw_i0", GroupBuilder.create()
                .addBox(-1.5f, -1, -1.5f, 3, 1, 1.5f, new CubeUV().down(34, 50, 31, 51.5f).north(50, 25, 47, 24).up(46, 26.5f, 43, 25).west(53.5f, 48, 52, 47).east(53.5f, 47, 52, 46)), PartPose.offset(0, 1, -4));
        head.addOrReplaceChild("right_eye_iris", GroupBuilder.create()
                .addMesh(new float[]{2.5f, 4.025f, 4.5f, 2.5f, 4.025f, 3.5f, 1.5f, 4.025f, 4.5f, 1.5f, 4.025f, 3.5f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16}, 6)
                .addMesh(new float[]{3, 4.025f, 5, 3, 4.025f, 3.5f, 2.5f, 4.025f, 4.5f, 2.5f, 4.025f, 3.5f, 2, 4.025f, 5, 2, 4.025f, 4.5f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16, 2, 0.5f, 0, 5, 0, 0, 4, 0, 0.5f, 0, 1, 0.5f}, 5)
                .addMesh(new float[]{-1.5f, 4.05f, 4.5f, -1.5f, 4.05f, 3.5f, -2.5f, 4.05f, 4.5f, -2.5f, 4.05f, 3.5f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16}, 8), PartPose.rotation(-1.5708f, 0, 0));
        head.addOrReplaceChild("left_eye_sclera", GroupBuilder.create()
                .addMesh(new float[]{-2, 4.05f, 4.5f, -2, 4.05f, 3.5f, -2.5f, 4.05f, 5, -2.5f, 4.05f, 3.5f, -1.5f, 4.05f, 5, -1.5f, 4.05f, 4.5f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16, 0, 0.5f, 0, 2, 0, 0.5f, 4, 1, 0.5f, 5, 1, 0}, 7), PartPose.offsetAndRotation(-0.5f, 0, 0, -1.5708f, 0, 0));
        GroupDefinition body = root.addOrReplaceChild("body", GroupBuilder.create()
                .addBox(-4, 0, -2, 8, 12, 4, new CubeUV().down(46, 31, 38, 35).north(18, 22, 10, 10).up(46, 31, 38, 27).west(13, 42, 9, 30).east(4, 37, 0, 25).south(26, 21, 18, 9))
                .addBox(-0.5f, 10, 2, 1, 1, 1.5f, new CubeUV().down(9, 36, 8, 37.5f).north(5, 6, 4, 5).up(18, 35.5f, 17, 34).west(53.5f, 50, 52, 49).east(53.5f, 49, 52, 48).south(18, 10, 17, 9))
                .addBox(-0.5f, 7, 2, 1, 1, 1.5f, new CubeUV().down(9, 40, 8, 41.5f).north(26, 9, 25, 8).up(9, 39.5f, 8, 38).west(53.5f, 52, 52, 51).east(53.5f, 51, 52, 50).south(5, 29, 4, 28))
                .addBox(-0.5f, 4, 2, 1, 1, 1.5f, new CubeUV().down(17, 44, 16, 45.5f).north(10, 30, 9, 29).up(17, 43.5f, 16, 42).west(1.5f, 54, 0, 53).east(53.5f, 53, 52, 52).south(18, 37, 17, 36))
                .addBox(-4, 0, -2, 8, 12, 4, new Vector3f(0.6f), new CubeUV().down(40, 34, 32, 38).north(28, 32, 20, 20).up(40, 11, 32, 7).west(20, 32, 16, 20).east(32, 32, 28, 20).south(40, 32, 32, 20), 2)
                .addBox(-4, 0, -2, 8, 3, 4, new Vector3f(0.5f), new CubeUV().down(40, 34, 32, 38).north(28, 32, 20, 27).up(40, 11, 32, 7).west(20, 32, 16, 27).east(32, 32, 28, 27).south(40, 32, 32, 27), 3), PartPose.offset(0, 12, 0));
        GroupDefinition tail = body.addOrReplaceChild("tail", GroupBuilder.create()
                ...
                .addBox(-0.5f, 2.5f, 0, 1, 1, 1, new CubeUV().down(54, 14, 53, 15).north(49, 13, 48, 12).up(54, 14, 53, 13).west(54, 13, 53, 12).east(7, 54, 6, 53).south(8, 54, 7, 53)), PartPose.offset(0, 0, 2.5f));
        GroupDefinition tail0 = tail.addOrReplaceChild("tail0", GroupBuilder.create()
                .addBox(-0.5f, 2.4f, 2, 1, 1, 1, new CubeUV().down(19, 53, 18, 54).north(54, 16, 53, 15).up(54, 18, 53, 17).west(18, 54, 17, 53).east(17, 54, 16, 53).south(54, 17, 53, 16)), PartPose.offset(0, 0, 4));
        GroupDefinition tail1 = tail0.addOrReplaceChild("tail1", GroupBuilder.create()
                .addBox(-0.5f, 2.4f, 2, 1, 1, 1, new CubeUV().down(23, 53, 22, 54).north(54, 19, 53, 18).up(54, 22, 53, 21).west(54, 21, 53, 20).east(20, 54, 19, 53).south(54, 20, 53, 19)), PartPose.offset(0, 0, 5));
        GroupDefinition tail2 = tail1.addOrReplaceChild("tail2", GroupBuilder.create()
                .addBox(-0.5f, 1.9f, 1.5f, 1, 1, 1, new CubeUV().down(37, 53, 36, 54).north(54, 23, 53, 22).up(26, 54, 25, 53).west(25, 54, 24, 53).east(24, 54, 23, 53).south(54, 24, 53, 23)), PartPose.offset(0, 0.5f, 5));
        tail2.addOrReplaceChild("tail3", GroupBuilder.create()
                .addBox(-0.5f, 1.4f, 1, 1, 1.5f, 1, new CubeUV().down(39, 53, 38, 54).north(3, 54.5f, 2, 53).up(38, 54, 37, 53).west(6, 54.5f, 5, 53).east(4, 54.5f, 3, 53).south(5, 54.5f, 4, 53)), PartPose.offset(0, 0.5f, 4));
        root.addOrReplaceChild("right_arm", GroupBuilder.create()
                .addBox(0, -10, -2, 4, 12, 4, new CubeUV().down(51, 4, 47, 8).north(17, 42, 13, 30).up(51, 4, 47, 0).west(38, 12, 34, 0).east(30, 44, 26, 32).south(34, 44, 30, 32))
                .addBox(1.5f, -4, 1, 1, 1, 2.5f, new CubeUV().down(1, 3, 0, 5.5f).north(40, 54, 39, 53).up(1, 2.5f, 0, 0).west(54.5f, 37, 52, 36).east(54.5f, 36, 52, 35).south(41, 54, 40, 53))
                .addBox(1.5f, -5, 1, 1, 1, 1.8f, new CubeUV().down(18, 30, 17, 32).north(42, 54, 41, 53).up(30, 5, 29, 3).west(54, 40, 52, 39).east(38, 53, 36, 52).south(47, 54, 46, 53))
                .addBox(0, -10, -2, 4, 12, 4, new Vector3f(0.6f), new CubeUV().north(48, 32, 44, 20).up(48, 20, 44, 16).west(52, 32, 48, 20).east(44, 32, 40, 20).south(56, 32, 52, 20), 2), PartPose.offset(4, 22, 0));
        root.addOrReplaceChild("left_arm", GroupBuilder.create()
                .addBox(-4, -10, -2, 4, 12, 4, new CubeUV().down(38, 48, 34, 52).north(8, 46, 4, 34).up(52, 12, 48, 8).west(38, 48, 34, 36).east(38, 24, 34, 12).south(38, 36, 34, 24))
                .addBox(-2.5f, -5, 1, 1, 1, 1.8f, new CubeUV().down(9, 34, 8, 36).north(49, 54, 48, 53).up(18, 34, 17, 32).west(54, 42, 52, 41).east(54, 41, 52, 40).south(50, 54, 49, 53))
                .addBox(-2.5f, -4, 1, 1, 1, 2.5f, new CubeUV().down(30, 0, 29, 2.5f).up(5, 27.5f, 4, 25).west(54.5f, 39, 52, 38).east(54.5f, 38, 52, 37).south(48, 54, 47, 53))
                .addBox(-4, -10, -2, 4, 12, 4, new Vector3f(0.6f), new CubeUV().north(56, 32, 52, 20).up(44, 20, 48, 16).west(40, 32, 44, 20).east(52, 32, 48, 20).south(48, 32, 44, 20), 2), PartPose.offset(-4, 22, 0));
        ...
        right_foot.addOrReplaceChild("right_foot_i0", GroupBuilder.create()
                .addBox(-1.3f, -6, -3.5f, 4f, 2, 5, new CubeUV().down(50, 30, 46, 35).north(52, 53, 48, 51).up(50, 30, 46, 25).west(55, 30, 50, 28).east(55, 28, 50, 26).south(56, 10, 52, 8))
                .addBox(-1.3f, -6, -3.5f, 4f, 2, 5, new Vector3f(0.6f), new CubeUV().down(12, 16, 8, 20).north(12, 20, 8, 16).up(12, 20, 8, 16).west(12, 20, 8, 16).east(12, 20, 8, 16).south(12, 20, 8, 16), 4), PartPose.rotation(0, 0, -0.1309f));
        right_leg_.addOrReplaceChild("right_leg__i0", GroupBuilder.create()
                .addBox(-2, -5, -2, 4, 6, 4, new CubeUV().down(53, 20, 49, 24).north(47, 19, 43, 13).west(46, 49, 42, 43).east(47, 25, 43, 19).south(42, 49, 38, 43))
                .addBox(-2, -5, -2, 4, 6, 4, new Vector3f(0.6f), new CubeUV().down(49, 16, 45, 20).north(8, 32, 4, 26).up(49, 16, 45, 12).west(4, 32, 0, 26).east(4, 32, 0, 26).south(8, 32, 4, 26), 4), PartPose.rotation(0.1309f, 0, 0));
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2, 0.3f, 1, 4, 2, 4, new CubeUV().north(8, 5, 4, 3).up(53, 16, 49, 12).west(55, 4, 51, 2).east(4, 53, 0, 51).south(55, 2, 51, 0))
                .addBox(-2, 0.3f, 1, 4, 2, 4, new Vector3f(0.59f), new CubeUV().down(49, 8, 45, 12).up(8, 29, 4, 25).west(8, 29, 4, 25).east(8, 29, 4, 25).south(8, 29, 4, 25), 3), PartPose.rotation(0.3491f, 0, 0));
        right_leg.addOrReplaceChild("right_leg_thigh", GroupBuilder.create()
                .addBox(-2, -8, -2, 4, 8, 4, new CubeUV().down(52, 39, 48, 43).north(34, 8, 30, 0).up(52, 39, 48, 35).west(42, 43, 38, 35).east(4, 45, 0, 37).south(26, 45, 22, 37))
                .addBox(-2, -8, -2, 4, 8, 4, new Vector3f(0.6f), new CubeUV().down(8, 25, 4, 29).north(8, 29, 4, 20).up(8, 20, 4, 16).west(12, 29, 8, 20).east(12, 29, 8, 20).south(16, 29, 12, 20), 3), PartPose.rotation(0.3491f, 0, 0));
        ...
        left_foot.addOrReplaceChild("left_foot_i0", GroupBuilder.create()
                .addBox(-2.7f, -6, -3.5f, 4f, 2, 5, new CubeUV().down(20, 46, 16, 51).north(20, 53, 16, 51).up(8, 51, 4, 46).west(31, 52, 26, 50).east(55, 26, 50, 24).south(26, 53, 22, 51))
                .addBox(-2.7f, -6, -3.5f, 4f, 2, 5, new Vector3f(0.6f), new CubeUV().down(8, 16, 12, 20).north(8, 20, 12, 16).up(12, 20, 8, 16).west(12, 16, 8, 20).east(12, 20, 8, 16).south(12, 20, 8, 16), 4), PartPose.rotation(0, 0, 0.1309f));
        left_leg_.addOrReplaceChild("left_leg__i0", GroupBuilder.create()
                .addBox(-2, -5, -2, 4, 6, 4, new CubeUV().down(42, 49, 38, 53).north(30, 50, 26, 44).west(26, 51, 22, 45).east(34, 50, 30, 44).south(4, 51, 0, 45))
                .addBox(-2, -5, -2, 4, 6, 4, new Vector3f(0.6f), new CubeUV().down(27, 46, 23, 50).north(4, 32, 8, 26).up(8, 50, 4, 46).west(0, 32, 4, 26).east(4, 32, 0, 26).south(4, 32, 0, 26), 4), PartPose.rotation(0.1309f, 0, 0));
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2, 0.3f, 1, 4, 2, 4, new CubeUV().up(53, 20, 49, 16).west(55, 8, 51, 6).east(8, 53, 4, 51).south(55, 6, 51, 4))
                .addBox(-2, 0.3f, 1, 4, 2, 4, new Vector3f(0.59f), new CubeUV().down(4, 46, 0, 50).north(53, 26, 49, 24).up(8, 29, 4, 25).west(4, 29, 8, 25).east(8, 29, 4, 25).south(8, 29, 4, 25), 3), PartPose.rotation(0.3491f, 0, 0));
        left_leg.addOrReplaceChild("left_leg_thigh", GroupBuilder.create()
                .addBox(-2, -8, -2, 4, 8, 4, new CubeUV().down(52, 47, 48, 51).north(12, 50, 8, 42).up(52, 47, 48, 43).west(47, 8, 43, 0).east(16, 50, 12, 42).south(46, 43, 42, 35))
                .addBox(-2, -8, -2, 4, 8, 4, new Vector3f(0.6f), new CubeUV().down(4, 25, 8, 29).north(4, 29, 8, 20).up(8, 20, 4, 16).west(12, 29, 8, 20).east(12, 29, 8, 20).south(16, 29, 12, 20), 3), PartPose.rotation(0.3491f, 0, 0));
