...
public class BeiFengModel<E extends LivingEntity> extends UniversalCustomModel<E> {
    ...
    public static ModelDefinition model(){
        ...
        right_leg_.addOrReplaceChild("right_leg__i0", GroupBuilder.create()
                ...
                .addBox(-2f, -5f, -2f, 4, 6, 4, new Vector3f(0.6f), new CubeUV().south(8, 32, 4, 26).west(4, 32, 0, 26).up(49, 16, 45, 12).north(8, 32, 4, 26).east(4, 32, 0, 26).down(49, 16, 45, 20), 4), PartPose.rotation(0.1309f, 0, 0));
        ...
        left_leg_.addOrReplaceChild("left_leg__i0", GroupBuilder.create()
                ...
                .addBox(-2f, -5f, -2f, 4, 6, 4, new Vector3f(0.6f), new CubeUV().south(4, 32, 0, 26).west(0, 32, 4, 26).up(8, 50, 4, 46).north(4, 32, 8, 26).east(4, 32, 0, 26).down(27, 46, 23, 50), 4), PartPose.rotation(0.1309f, 0, 0));
