...
public class LatexWolfFemaleModel<T extends LivingEntity> extends AbstractLatexEntityModel<T> {
    ...
    public static @NotNull LayerDefinition createBodyLayer() {
        ...
        PartDefinition ear_inner_r1 = left_ear.addOrReplaceChild("ear_inner_r1", CubeListBuilder.create().texOffs(12, 55).addBox(-0.72F, -4.5F, -0.2F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -9.0F, -2.0F, -1.1266F, 0.3822F, 0.3645F));

        PartDefinition right_ear = head.addOrReplaceChild("right_ear", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition ear_inner_r2 = right_ear.addOrReplaceChild("ear_inner_r2", CubeListBuilder.create().texOffs(24, 55).addBox(-1.28F, -4.5F, -0.2F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -9.0F, -2.0F, -1.1266F, -0.3822F, -0.3645F));
        ...
        PartDefinition body_r1 = body.addOrReplaceChild("body_r1", CubeListBuilder.create().texOffs(54, 25).addBox(-1.7F, -2.0F, -2.0F, 3.4F, 3.4F, 3.0F, new CubeDeformation(0.0F))
    ...
    public static @NotNull ModelLayerLocation modelLayerLocation = new ModelLayerLocation(AChanged.resourceLoc("latex_wolf_female"), "main");
    ...
    public static @NotNull ModelLayerLocation armorLayerLocation = new ModelLayerLocation(AChanged.resourceLoc("latex_wolf_female"), "armor");
    ...
    public void setupAnim(@NotNull T p_102618_, float p_102619_, float p_102620_, float p_102621_, float p_102622_, float p_102623_) {
        ...
        animate(state,ears,p_102621_);
    }

    public static final AnimationDefinition ears = AnimationDefinition.Builder.withLength(4.0F).looping()
