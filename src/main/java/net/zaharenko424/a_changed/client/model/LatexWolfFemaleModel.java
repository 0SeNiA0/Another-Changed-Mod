...
public class LatexWolfFemaleModel<E extends LivingEntity> extends AbstractLatexEntityModel<E> {
    ...
    public static @NotNull ModelDefinition bodyLayer(){
        ...
        GroupDefinition head = root.addOrReplaceChild("head", GroupBuilder.create()
                ...
                .addBox(-2f, 1f, -6f, 4f, 2f, 2f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(47f, 26f, 45f, 24f), Direction.NORTH, new UVData(53f, 24f, 49f, 22f), Direction.EAST, new UVData(25f, 46f, 23f, 44f), Direction.UP, new UVData(53f, 49f, 49f, 47f), Direction.DOWN, new UVData(53f, 49f, 49f, 51f), Direction.SOUTH, new UVData(49f, 51f, 45f, 49f)))
                .addBox(-1.5f, 0f, -5.5f, 3f, 1f, 1.5f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(53.5f, 37f, 52f, 36f), Direction.NORTH, new UVData(40f, 34f, 37f, 33f), Direction.EAST, new UVData(36.5f, 53f, 35f, 52f), Direction.UP, new UVData(28f, 37.5f, 25f, 36f), Direction.DOWN, new UVData(15f, 50f, 12f, 51.5f), Direction.SOUTH, new UVData(21f, 53f, 18f, 52f))), PartPose.offset(0f, 24f, 0f));
        GroupDefinition right_ear = head.addOrReplaceChild("right_ear", GroupBuilder.create()
                .addBox(-1f, -2f, -1f, 2f, 7f, 5f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(13f, 39f, 8f, 32f), Direction.NORTH, new UVData(29f, 53f, 27f, 46f), Direction.EAST, new UVData(37f, 7f, 32f, 0f), Direction.UP, new UVData(51f, 11f, 49f, 6f), Direction.DOWN, new UVData(10f, 49f, 8f, 54f), Direction.SOUTH, new UVData(31f, 53f, 29f, 46f))), PartPose.offsetAndRotation(3f, 7f, -1f, 0.4276f, 0.384f, -0.3665f));
        right_ear.addOrReplaceChild("right_ear_inner", GroupBuilder.create()
                .addBox(-1f, 3.3f, -2.7f, 2f, 1f, 4f, new Vector3f(-0.01f), ImmutableMap.of(Direction.WEST, new UVData(41f, 7f, 37f, 6f), Direction.NORTH, new UVData(47f, 27f, 45f, 26f), Direction.EAST, new UVData(36f, 12f, 32f, 11f), Direction.UP, new UVData(2f, 54f, 0f, 50f), Direction.DOWN, new UVData(4f, 50f, 2f, 54f), Direction.SOUTH, new UVData(23f, 53f, 21f, 52f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.7854f, 0f, 0f));
        GroupDefinition left_ear = head.addOrReplaceChild("left_ear", GroupBuilder.create()
                .addBox(-1f, -2f, -1f, 2f, 7f, 5f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(37f, 34f, 32f, 27f), Direction.NORTH, new UVData(33f, 53f, 31f, 46f), Direction.EAST, new UVData(37f, 27f, 32f, 20f), Direction.UP, new UVData(12f, 54f, 10f, 49f), Direction.DOWN, new UVData(51f, 11f, 49f, 16f), Direction.SOUTH, new UVData(35f, 53f, 33f, 46f))), PartPose.offsetAndRotation(-3f, 7f, -1f, 0.4276f, -0.384f, 0.3665f));
        left_ear.addOrReplaceChild("left_ear_inner", GroupBuilder.create()
                .addBox(-1f, 3.3f, -2.7f, 2f, 1f, 4f, new Vector3f(-0.01f), ImmutableMap.of(Direction.WEST, new UVData(49f, 52f, 45f, 51f), Direction.NORTH, new UVData(25f, 53f, 23f, 52f), Direction.EAST, new UVData(39f, 52f, 35f, 51f), Direction.UP, new UVData(6f, 54f, 4f, 50f), Direction.DOWN, new UVData(8f, 50f, 6f, 54f), Direction.SOUTH, new UVData(27f, 53f, 25f, 52f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.7854f, 0f, 0f));
        ...
        GroupDefinition tail_0 = tail.addOrReplaceChild("tail_0", GroupBuilder.create()
                ...
                .addBox(-1f, -1f, 7f, 2f, 2f, 2f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(14f, 54f, 12f, 52f), Direction.NORTH, new UVData(37f, 48f, 35f, 46f), Direction.EAST, new UVData(51f, 53f, 49f, 51f), Direction.UP, new UVData(16f, 54f, 14f, 52f), Direction.DOWN, new UVData(18f, 52f, 16f, 54f), Direction.SOUTH, new UVData(53f, 53f, 51f, 51f))), PartPose.offsetAndRotation(0f, 0f, 4f, 0.1309f, 0f, 0f));
        ...
        GroupDefinition armor_body = body.addOrReplaceChild("armor_body", GroupBuilder.create()
                .addBox(-4f, 0f, -2f, 8f, 12f, 4f, new Vector3f(0.6f), ImmutableMap.of(Direction.WEST, new UVData(20f, 32f, 16f, 20f), Direction.NORTH, new UVData(28f, 32f, 20f, 20f), Direction.EAST, new UVData(32f, 32f, 28f, 20f), Direction.UP, new UVData(40f, 11f, 32f, 7f), Direction.DOWN, new UVData(40f, 34f, 32f, 38f), Direction.SOUTH, new UVData(40f, 32f, 32f, 20f))), PartPose.offset(0f, 0f, 0f));
        armor_body.addOrReplaceChild("cube", GroupBuilder.create()
                .addBox(-1.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3f, new Vector3f(0.6f), ImmutableMap.of(Direction.WEST, new UVData(37f, 28f, 34f, 24.5f), Direction.NORTH, new UVData(12f, 20f, 8f, 16f), Direction.EAST, new UVData(38f, 28f, 35f, 24.5f), Direction.UP, new UVData(52.5f, 3f, 49f, 0f), Direction.DOWN, new UVData(12f, 16f, 8f, 20f), Direction.SOUTH, new UVData(22.5f, 51.5f, 19f, 48f)))
                .addBox(2.2f, -1.8f, -1.5f, 3.5f, 3.5f, 3f, new Vector3f(0.6f), ImmutableMap.of(Direction.WEST, new UVData(37f, 28f, 34f, 24.5f), Direction.NORTH, new UVData(12f, 20f, 8f, 16f), Direction.EAST, new UVData(37f, 28f, 34f, 24.5f), Direction.UP, new UVData(38.5f, 51f, 35f, 48f), Direction.DOWN, new UVData(12f, 16f, 8f, 20f), Direction.SOUTH, new UVData(50.5f, 31.5f, 47f, 28f))), PartPose.offsetAndRotation(-2f, 8.3f, -2f, 0.48f, 0f, 0f));
        body.addOrReplaceChild("cube_i0", GroupBuilder.create()
                .addBox(-1.8f, -1.8f, -1.5f, 3.5f, 3.5f, 3f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(51f, 35.5f, 48f, 32f), Direction.NORTH, new UVData(50.5f, 27.5f, 47f, 24f), Direction.EAST, new UVData(16f, 35.5f, 13f, 32f), Direction.UP, new UVData(38.5f, 51f, 35f, 48f), Direction.DOWN, new UVData(51.5f, 36f, 48f, 39f), Direction.SOUTH, new UVData(50.5f, 31.5f, 47f, 28f)))
                .addBox(-5.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(45f, 51.5f, 42f, 48f), Direction.NORTH, new UVData(18.5f, 51.5f, 15f, 48f), Direction.EAST, new UVData(42f, 51.5f, 39f, 48f), Direction.UP, new UVData(52.5f, 3f, 49f, 0f), Direction.DOWN, new UVData(52.5f, 3f, 49f, 6f), Direction.SOUTH, new UVData(22.5f, 51.5f, 19f, 48f))), PartPose.offsetAndRotation(2f, 8.3f, -2f, 0.48f, 0f, 0f));
        ...
        right_foot.addOrReplaceChild("right_foot_i0", GroupBuilder.create()
                .addBox(-1.3f, -6f, -3.5f, 4f, 2f, 5f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(54f, 18f, 49f, 16f), Direction.NORTH, new UVData(55f, 14f, 51f, 12f), Direction.EAST, new UVData(53f, 41f, 48f, 39f), Direction.UP, new UVData(44f, 38f, 40f, 33f), Direction.DOWN, new UVData(45f, 12f, 41f, 17f), Direction.SOUTH, new UVData(55f, 16f, 51f, 14f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, 0f, -0.1309f));
        right_foot.addOrReplaceChild("armor_right_foot", GroupBuilder.create()
                .addBox(-1.3f, -6f, -3.5f, 4f, 2f, 5f, new Vector3f(0.6f), ImmutableMap.of(Direction.WEST, new UVData(12f, 20f, 8f, 16f), Direction.NORTH, new UVData(12f, 20f, 8f, 16f), Direction.EAST, new UVData(12f, 20f, 8f, 16f), Direction.UP, new UVData(12f, 20f, 8f, 16f), Direction.DOWN, new UVData(8f, 20f, 12f, 16f), Direction.SOUTH, new UVData(12f, 20f, 8f, 16f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, 0f, -0.1309f));
        ...
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4f, 2f, 4f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(55f, 12f, 51f, 10f), Direction.NORTH, new UVData(27f, 52f, 23f, 50f), Direction.EAST, new UVData(55f, 8f, 51f, 6f), Direction.UP, new UVData(12f, 49f, 8f, 45f), Direction.DOWN, new UVData(49f, 8f, 45f, 12f), Direction.SOUTH, new UVData(55f, 10f, 51f, 8f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.3491f, 0f, 0f));
        right_leg_shin.addOrReplaceChild("armor_right_leg_shin", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4f, 2f, 4f, new Vector3f(0.59f), ImmutableMap.of(Direction.WEST, new UVData(8f, 25f, 4f, 29f), Direction.EAST, new UVData(8f, 25f, 4f, 29f), Direction.UP, new UVData(8f, 25f, 4f, 29f), Direction.SOUTH, new UVData(8f, 25f, 4f, 29f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.3491f, 0f, 0f));
        ...
        left_foot.addOrReplaceChild("left_foot_i0", GroupBuilder.create()
                .addBox(-2.7f, -6f, -3.5f, 4f, 2f, 5f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(54f, 22f, 49f, 20f), Direction.NORTH, new UVData(55f, 34f, 51f, 32f), Direction.EAST, new UVData(54f, 20f, 49f, 18f), Direction.UP, new UVData(45f, 22f, 41f, 17f), Direction.DOWN, new UVData(45f, 22f, 41f, 27f), Direction.SOUTH, new UVData(55f, 36f, 51f, 34f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, 0f, 0.1309f));
        ...
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4f, 2f, 4f, new Vector3f(), ImmutableMap.of(Direction.WEST, new UVData(55f, 32f, 51f, 30f), Direction.NORTH, new UVData(55f, 26f, 51f, 24f), Direction.EAST, new UVData(55f, 28f, 51f, 26f), Direction.UP, new UVData(49f, 49f, 45f, 45f), Direction.DOWN, new UVData(4f, 46f, 0f, 50f), Direction.SOUTH, new UVData(55f, 30f, 51f, 28f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.3491f, 0f, 0f));
        left_leg_shin.addOrReplaceChild("armor_left_leg_shin", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4f, 2f, 4f, new Vector3f(0.59f), ImmutableMap.of(Direction.WEST, new UVData(4f, 25f, 8f, 29f), Direction.EAST, new UVData(8f, 25f, 4f, 29f), Direction.UP, new UVData(8f, 25f, 4f, 29f), Direction.SOUTH, new UVData(8f, 25f, 4f, 29f))), PartPose.offsetAndRotation(0f, 0f, 0f, 0.3491f, 0f, 0f));
