...
public class SnowLeopardMaleModel<E extends LivingEntity> extends CustomHumanoidModel<E> {
    ...
    public static ModelDefinition bodyLayer() {
        ...
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(52, 46, 48, 42).east(57, 2, 53, 0).down(48, 48, 44, 52).north(56, 54, 52, 52).west(57, 6, 53, 4).south(57, 4, 53, 2)), PartPose.rotation(0.3491f, 0, 0));
        ...
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(53, 25, 49, 21).east(57, 22, 53, 20).down(53, 25, 49, 29).north(57, 12, 53, 10).west(57, 26, 53, 24).south(57, 24, 53, 22)), PartPose.rotation(0.3491f, 0, 0));
