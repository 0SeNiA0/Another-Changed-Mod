...
public class SnowLeopardMaleModel<E extends LivingEntity>  extends UniversalCustomModel<E> {
    ...
    public static ModelDefinition model(){
        ...
        GroupDefinition head = root.addOrReplaceChild("head", GroupBuilder.create()
                ...
                .addBox(-4f, 0f, -4f, 8, 8, 8, new Vector3f(0.6f), new CubeUV().south(32, 16, 24, 8).west(24, 16, 16, 8).up(16, 8, 8, 0).north(16, 16, 8, 8).east(8, 16, 0, 8).down(24, 0, 16, 8), 1), PartPose.offset(0, 24, 0));
        ...
        head.addOrReplaceChild("maw", GroupBuilder.create()
                .addBox(-2f, -1f, -2f, 4, 2, 2, new CubeUV().south(56, 48, 52, 46).west(32, 48, 30, 46).up(56, 50, 52, 48).north(34, 54, 30, 52).east(20, 46, 18, 44).down(56, 50, 52, 52)), PartPose.offset(0, 2, -4));
        ...
        GroupDefinition body = root.addOrReplaceChild("body", GroupBuilder.create()
                ...
                .addBox(-4f, 0f, -2f, 8, 12, 4, new Vector3f(0.6f), new CubeUV().south(40, 32, 32, 20).west(20, 32, 16, 20).up(40, 11, 32, 7).north(28, 32, 20, 20).east(32, 32, 28, 20).down(40, 34, 32, 38), 2)
                .addBox(-4f, 0f, -2f, 8, 3, 4, new Vector3f(0.5f), new CubeUV().south(40, 32, 32, 27).west(20, 32, 16, 27).up(40, 11, 32, 7).north(28, 32, 20, 27).east(32, 32, 28, 27).down(40, 34, 32, 38), 3), PartPose.offset(0, 12, 0));
        ...
        root.addOrReplaceChild("right_arm", GroupBuilder.create()
                ...
                .addBox(0f, -10f, -2f, 4, 12, 4, new Vector3f(0.6f), new CubeUV().south(56, 32, 52, 20).west(52, 32, 48, 20).up(48, 20, 44, 16).north(48, 32, 44, 20).east(44, 32, 40, 20), 2), PartPose.offset(4, 22, 0));
        root.addOrReplaceChild("left_arm", GroupBuilder.create()
                ...
                .addBox(-4f, -10f, -2f, 4, 12, 4, new Vector3f(0.6f), new CubeUV().south(48, 32, 44, 20).west(40, 32, 44, 20).up(44, 20, 48, 16).north(56, 32, 52, 20).east(52, 32, 48, 20), 2), PartPose.offset(-4, 22, 0));
        ...
        right_leg_.addOrReplaceChild("right_leg__i0", GroupBuilder.create()
                ...
                .addBox(-2f, -5f, -2f, 4, 6, 4, new Vector3f(0.6f), new CubeUV().south(4, 32, 0, 26).west(8, 32, 4, 26).up(49, 16, 45, 12).north(4, 32, 0, 26).east(8, 32, 4, 26).down(49, 16, 45, 20), 4), PartPose.rotation(0.1309f, 0, 0));
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().south(57, 4, 53, 2).west(57, 6, 53, 4).up(52, 46, 48, 42).north(56, 54, 52, 52).east(57, 2, 53, 0).down(48, 48, 44, 52))
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new Vector3f(0.59f), new CubeUV().south(8, 29, 4, 25).west(8, 29, 4, 25).up(8, 29, 4, 25).east(8, 29, 4, 25).down(49, 8, 45, 12), 3), PartPose.rotation(0.3491f, 0, 0));
        right_leg.addOrReplaceChild("right_leg_thigh", GroupBuilder.create()
                ...
                .addBox(-2f, -8f, -2f, 4, 8, 4, new Vector3f(0.6f), new CubeUV().south(16, 29, 12, 20).west(12, 29, 8, 20).up(8, 20, 4, 16).north(8, 29, 4, 20).east(12, 29, 8, 20).down(8, 25, 4, 29), 3), PartPose.rotation(0.3491f, 0, 0));
        ...
        left_leg_.addOrReplaceChild("left_leg__i0", GroupBuilder.create()
                ...
                .addBox(-2f, -5f, -2f, 4, 6, 4, new Vector3f(0.6f), new CubeUV().south(4, 32, 0, 26).west(4, 32, 8, 26).up(8, 50, 4, 46).north(0, 32, 4, 26).east(8, 32, 4, 26).down(27, 46, 23, 50), 4), PartPose.rotation(0.1309f, 0, 0));
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().south(57, 24, 53, 22).west(57, 26, 53, 24).up(53, 25, 49, 21).north(57, 12, 53, 10).east(57, 22, 53, 20).down(53, 25, 49, 29))
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new Vector3f(0.59f), new CubeUV().south(8, 29, 4, 25).west(4, 29, 8, 25).up(8, 29, 4, 25).north(53, 26, 49, 24).east(8, 29, 4, 25).down(4, 46, 0, 50), 3), PartPose.rotation(0.3491f, 0, 0));
        left_leg.addOrReplaceChild("left_leg_thigh", GroupBuilder.create()
                ...
                .addBox(-2f, -8f, -2f, 4, 8, 4, new Vector3f(0.6f), new CubeUV().south(16, 29, 12, 20).west(12, 29, 8, 20).up(8, 20, 4, 16).north(4, 29, 8, 20).east(12, 29, 8, 20).down(4, 25, 8, 29), 3), PartPose.rotation(0.3491f, 0, 0));
