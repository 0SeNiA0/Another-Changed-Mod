...
public class YufengDragonModel <E extends LivingEntity> extends CustomHumanoidModel<E> {
    ...
    public static ModelDefinition bodyLayer() {
        ...
        head.addOrReplaceChild("right_ear", GroupBuilder.create()
                .addMesh(new float[]{-1, 5, 4, -1, 5, -1, -1, -2, 4, -1, -2, -1, 1, 5, 4, 1, 5, -1, 1, -2, 4, 1, -2, -1, -0.99f, 2, 4, -0.99f, 5, 1, -0.99f, 1.4284f, 3.2527f, 0.99f, 2, 4, 0.99f, 5, 1}, new float[]{0, 33, 12, 1, 28, 12, 3, 28, 19, 2, 33, 19, 5, 33, 19, 4, 28, 19, 6, 28, 26, 7, 33, 26, 5, 43, 25, 1, 41, 25, 0, 41, 30, 4, 43, 30, 4, 14, 37, 0, 12, 37, 2, 12, 44, 6, 14, 44, 1, 10, 50, 5, 8, 50, 7, 8, 57, 3, 10, 57, 12, 58, 17, 9, 56, 17, 8, 56, 21, 11, 58, 21}), PartPose.rotation(0.4276f, 0.384f, -0.3665f));
        head.addOrReplaceChild("left_ear", GroupBuilder.create()
                .addMesh(new float[]{1, 5, 4, 1, 5, -1, 1, -2, 4, 1, -2, -1, -1, 5, 4, -1, 5, -1, -1, -2, 4, -1, -2, -1, 0.99f, 2, 4, 0.99f, 5, 1, 0.99f, 1.4284f, 3.2527f, -0.99f, 2, 4, -0.99f, 5, 1}, new float[]{3, 33, 33, 1, 33, 26, 0, 28, 26, 2, 28, 33, 6, 37, 7, 4, 37, 0, 5, 32, 0, 7, 32, 7, 0, 51, 38, 1, 51, 33, 5, 49, 33, 4, 49, 38, 2, 12, 57, 0, 12, 50, 4, 10, 50, 6, 10, 57, 7, 26, 57, 5, 26, 50, 1, 24, 50, 3, 24, 57, 8, 58, 51, 9, 58, 47, 12, 56, 47, 11, 56, 51}), PartPose.rotation(0.4276f, -0.384f, 0.3665f));
        ...
        GroupDefinition body = root.addOrReplaceChild("body", GroupBuilder.create()
                .addBox(-4f, 0f, -2f, 8, 12, 4, new CubeUV().up(41, 30, 33, 26).east(12, 32, 8, 20).down(36, 33, 28, 37).north(8, 12, 0, 0).west(16, 32, 12, 20).south(16, 12, 8, 0)));
        GroupDefinition wings = body.addOrReplaceChild("wings", GroupBuilder.create()
                .addBox(-1f, -3f, -1f, 2, 5, 1, new CubeUV().up(50, 17, 48, 16).east(43, 20, 42, 15).down(51, 38, 49, 39).north(56, 5, 54, 0).west(59, 22, 58, 17).south(56, 10, 54, 5)));
        ...
        GroupDefinition tail = body.addOrReplaceChild("tail", GroupBuilder.create()
                .addBox(-2.4f, -2.4f, -3f, 4.8f, 4.8f, 7, new CubeUV().up(38, 19, 33, 12).east(39, 12, 32, 7).down(38, 19, 33, 26).north(42, 5, 37, 0).west(15, 37, 8, 32).south(43, 25, 38, 20)), PartPose.rotation(0.7418f, 0, 0));
        GroupDefinition tail_0 = tail.addOrReplaceChild("tail_0", GroupBuilder.create()
                .addBox(-2.1f, -1.8f, -0.5f, 4.2f, 4.2f, 6, new CubeUV().up(4, 46, 0, 40).east(41, 42, 35, 38).down(8, 40, 4, 46).north(49, 39, 45, 35).west(45, 9, 39, 5).south(51, 21, 47, 17)), PartPose.rotation(-0.1309f, 0, 0));
        GroupDefinition tail_1 = tail_0.addOrReplaceChild("tail_1", GroupBuilder.create()
                .addBox(-1.8f, -1.3f, 0f, 3.6f, 3.7f, 5, new CubeUV().up(11.5f, 50, 8, 45).east(49, 30.5f, 44, 27).down(27.5f, 45, 24, 50).north(55.5f, 50.5f, 52, 47).west(49, 34.5f, 44, 31).south(55.5f, 54.5f, 52, 51)), PartPose.rotation(-0.1309f, 0, 0));
        GroupDefinition tail_2 = tail_1.addOrReplaceChild("tail_2", GroupBuilder.create()
                .addBox(-1.5f, -1.3f, -0.5f, 3, 3.2f, 4.5f, new CubeUV().up(43, 56.5f, 40, 52).east(55.5f, 19, 51, 16).down(46, 52, 43, 56.5f).north(36, 33, 33, 30).west(55.5f, 22, 51, 19).south(42, 12, 39, 9)), PartPose.rotation(-0.0873f, 0, 0));
        GroupDefinition tail_3 = tail_2.addOrReplaceChild("tail_3", GroupBuilder.create()
                .addBox(-1f, -1f, 0f, 2, 2.4f, 3, new CubeUV().up(47, 42, 45, 39).east(60, 59.5f, 57, 57).down(53, 22, 51, 25).north(63, 57.5f, 61, 55).west(61, 2.5f, 58, 0).south(63, 63.5f, 61, 61)), PartPose.rotation(-0.0873f, 0, 0));
        ...
        GroupDefinition right_arm = root.addOrReplaceChild("right_arm", GroupBuilder.create()
                .addBox(0f, -10f, -2f, 4, 12, 4, new CubeUV().up(51, 25, 47, 21).east(28, 24, 24, 12).down(51, 39, 47, 43).north(28, 12, 24, 0).west(24, 36, 20, 24).south(20, 36, 16, 24)));
        ...
        GroupDefinition left_arm = root.addOrReplaceChild("left_arm", GroupBuilder.create()
                .addBox(-4f, -10f, -2f, 4, 12, 4, new CubeUV().up(51, 47, 47, 43).east(4, 40, 0, 28).down(51, 47, 47, 51).north(28, 36, 24, 24).west(8, 40, 4, 28).south(32, 12, 28, 0)));
        ...
        right_leg_.addOrReplaceChild("right_leg__i0", GroupBuilder.create()
                .addBox(-2f, -5f, -2f, 4, 6, 4, new CubeUV().up(39, 52, 35, 48).east(45, 42, 41, 36).down(43, 48, 39, 52).north(44, 36, 40, 30).west(39, 48, 35, 42).south(46, 15, 42, 9)), PartPose.rotation(7.5f, 0, 0));
        ...
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(52, 12, 48, 8).east(61, 14, 57, 12).down(52, 12, 48, 16).north(61, 10, 57, 8).west(61, 32, 57, 30).south(61, 30, 57, 28)), PartPose.rotation(20, 0, 0));
        ...
        right_leg.addOrReplaceChild("right_leg_thigh", GroupBuilder.create()
                .addBox(-2f, -8f, -2f, 4, 8, 4, new CubeUV().up(52, 4, 48, 0).east(23, 44, 19, 36).down(52, 4, 48, 8).north(19, 44, 15, 36).west(40, 38, 36, 30).south(27, 44, 23, 36)), PartPose.rotation(20, 0, 0));
        ...
        left_leg_.addOrReplaceChild("left_leg__i0", GroupBuilder.create()
                .addBox(-2f, -5f, -2f, 4, 6, 4, new CubeUV().up(53, 29, 49, 25).east(47, 21, 43, 15).down(53, 29, 49, 33).north(43, 48, 39, 42).west(47, 48, 43, 42).south(47, 27, 43, 21)), PartPose.rotation(7.5f, 0, 0));
        ...
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(20, 53, 16, 49).east(61, 45, 57, 43).down(24, 49, 20, 53).north(44, 59, 40, 57).west(61, 53, 57, 51).south(61, 47, 57, 45)), PartPose.rotation(20, 0, 0));
        ...
        left_leg.addOrReplaceChild("left_leg_thigh", GroupBuilder.create()
                .addBox(-2f, -8f, -2f, 4, 8, 4, new CubeUV().up(47, 52, 43, 48).east(31, 45, 27, 37).down(16, 49, 12, 53).north(12, 45, 8, 37).west(42, 20, 38, 12).south(35, 45, 31, 37)), PartPose.rotation(20, 0, 0));
