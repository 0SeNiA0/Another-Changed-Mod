...
public class DarkLatexPupModel <E extends LivingEntity> extends UniversalCustomModel<E> {
    ...
    public DarkLatexPupModel() {
        super(ModelDefinitionCache.getInstance().bake(bodyLayer), Util.make(new ModelPropertyMapImpl(), map -> {
            ...
            map.addLast(ModelPropertyRegistry.ITEM_IN_MAW.get(), new ItemInMawLayer("head", new PoseTransform(new Vector3f(0, -.15f, -.3f), null, null)));
    ...
    public static ModelDefinition model() {
        ...
        root.addOrReplaceChild("upper_body", GroupBuilder.create()
                .addBox(-4f, -3f, -3f, 8, 6, 7, new CubeUV().west(43, 13, 36, 7).up(36, 7, 28, 0).down(44, 0, 36, 7).north(36, 13, 28, 7).east(28, 13, 21, 7).south(51, 13, 43, 7)), PartPose.offsetAndRotation(0, 10, -3, -1.5708f, 0, 0));
        root.addOrReplaceChild("body", GroupBuilder.create()
                .addBox(-3f, -7f, -3f, 6, 9, 6, new CubeUV().west(36, 29, 30, 20).up(30, 20, 24, 14).down(36, 14, 30, 20).north(30, 29, 24, 20).east(24, 29, 18, 20).south(42, 29, 36, 20)), PartPose.offsetAndRotation(0, 10, 2, -1.5708f, 0, 0));
        root.addOrReplaceChild("right_leg_front", GroupBuilder.create()
                .addBox(1f, -8f, -1f, 2, 8, 2, new CubeUV().west(6, 28, 4, 20).up(4, 20, 2, 18).down(6, 18, 4, 20).north(4, 28, 2, 20).east(2, 28, 0, 20).south(8, 28, 6, 20)), PartPose.offset(-0.5f, 8, -4));
        root.addOrReplaceChild("left_leg_front", GroupBuilder.create()
                .addBox(-3f, -8f, -1f, 2, 8, 2, new CubeUV().west(6, 28, 4, 20).up(4, 20, 2, 18).down(6, 18, 4, 20).north(4, 28, 2, 20).east(2, 28, 0, 20).south(8, 28, 6, 20)), PartPose.offset(0.5f, 8, -4));
        root.addOrReplaceChild("right_leg_back", GroupBuilder.create()
                .addBox(-2f, -8f, -1f, 2, 8, 2, new CubeUV().west(6, 28, 4, 20).up(4, 20, 2, 18).down(6, 18, 4, 20).north(4, 28, 2, 20).east(2, 28, 0, 20).south(8, 28, 6, 20)), PartPose.offset(2.5f, 8, 7));
        root.addOrReplaceChild("left_leg_back", GroupBuilder.create()
                .addBox(0f, -8f, -1f, 2, 8, 2, new CubeUV().west(6, 28, 4, 20).up(4, 20, 2, 18).down(6, 18, 4, 20).north(4, 28, 2, 20).east(2, 28, 0, 20).south(8, 28, 6, 20)), PartPose.offset(-2.5f, 8, 7));
