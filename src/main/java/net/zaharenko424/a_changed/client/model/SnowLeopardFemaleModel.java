...
public class SnowLeopardFemaleModel<E extends LivingEntity>  extends UniversalCustomModel<E> {
    ...
    public SnowLeopardFemaleModel() {
        super(ModelDefinitionCache.getInstance().bake(bodyLayer),
                ...
                List.of(new CutOut(0), new VanillaTexArmor(ArmorItem.Type.HELMET), new VanillaTexArmor(ArmorItem.Type.CHESTPLATE), new VanillaTexArmor(ArmorItem.Type.LEGGINGS), new VanillaTexArmor(ArmorItem.Type.BOOTS),
                        new OpaqueColor(ModelPropertyKeys.RIGHT_SCLERA, -65794), new OpaqueColor(ModelPropertyKeys.RIGHT_IRIS, -15993276), new OpaqueColor(ModelPropertyKeys.LEFT_SCLERA, -65794), new OpaqueColor(ModelPropertyKeys.LEFT_IRIS, -15993276),
                        new OpaqueColor(ModelPropertyKeys.BEANS, -4671304)),
    ...
    public static ModelDefinition model(){
        ...
        GroupDefinition head = root.addOrReplaceChild("head", GroupBuilder.create()
                ...
                .addBox(-4, 0, -4, 8, 8, 8, new Vector3f(0.6f), new CubeUV().down(24, 0, 16, 8).north(16, 16, 8, 8).up(16, 8, 8, 0).west(24, 16, 16, 8).east(8, 16, 0, 8).south(32, 16, 24, 8), 1)
                .addMesh(new float[]{2.6f, 4.5f, -4.01f, 2.6f, 3.5f, -4.01f, 1.9f, 4.5f, -4.01f, 1.9f, 3.5f, -4.01f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16}, 6)
                .addMesh(new float[]{1.9f, 4.5f, -4.01f, 1.9f, 3.5f, -4.01f, 1.5f, 4.5f, -4.01f, 1.5f, 3.5f, -4.01f, 3, 4.5f, -4.01f, 3, 3.5f, -4.01f, 2.6f, 4.5f, -4.01f, 2.6f, 3.5f, -4.01f}, new float[]{0, 16, 16, 1, 16, 0, 3, 0, 0, 2, 0, 16, 4, 16, 16, 5, 16, 0, 7, 0, 0, 6, 0, 16}, 5)
                .addMesh(new float[]{-2.6f, 4.5f, -4.01f, -2.6f, 3.5f, -4.01f, -1.9f, 4.5f, -4.01f, -1.9f, 3.5f, -4.01f}, new float[]{3, 0, 0, 1, 16, 0, 0, 16, 16, 2, 0, 16}, 8)
                .addMesh(new float[]{-1.9f, 4.5f, -4.01f, -1.9f, 3.5f, -4.01f, -1.5f, 4.5f, -4.01f, -1.5f, 3.5f, -4.01f, -3, 4.5f, -4.01f, -3, 3.5f, -4.01f, -2.6f, 4.5f, -4.01f, -2.6f, 3.5f, -4.01f}, new float[]{3, 0, 0, 1, 16, 0, 0, 16, 16, 2, 0, 16, 7, 0, 0, 5, 16, 0, 4, 16, 16, 6, 0, 16}, 7), PartPose.offset(0, 24, 0));
        ...
        head.addOrReplaceChild("maw", GroupBuilder.create()
                .addBox(-2, -1, -2, 4, 2, 2, new CubeUV().down(22, 54, 18, 56).north(8, 56, 4, 54).up(58, 19, 54, 17).west(32, 48, 30, 46).east(20, 46, 18, 44).south(58, 17, 54, 15)), PartPose.offset(0, 2, -4));
        head.addOrReplaceChild("maw_i0", GroupBuilder.create()
                .addBox(-1.5f, -1, -1.5f, 3, 1, 1.5f, new CubeUV().down(49, 35, 46, 36.5f).north(40, 7, 37, 6).up(49, 22.5f, 46, 21).west(46.5f, 43, 45, 42).east(43.5f, 39, 42, 38).south(44, 6, 41, 5)), PartPose.offset(0, 1, -4));
        GroupDefinition body = root.addOrReplaceChild("body", GroupBuilder.create()
                .addBox(-4, 0, -2, 8, 12, 4, new CubeUV().down(16, 32, 8, 36).north(8, 12, 0, 0).up(40, 11, 32, 7).west(16, 32, 12, 20).east(12, 32, 8, 20).south(16, 12, 8, 0))
        ...
        body.addOrReplaceChild("armor_body", GroupBuilder.create()
                .addBox(-3.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().down(12, 16, 8, 20).north(12, 20, 8, 16).up(52.5f, 3, 49, 0).west(37, 28, 34, 24.5f).east(38, 28, 35, 24.5f).south(22.5f, 51.5f, 19, 48), 2)
                .addBox(0.2f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().down(12, 16, 8, 20).north(12, 20, 8, 16).up(38.5f, 51, 35, 48).west(37, 28, 34, 24.5f).east(37, 28, 34, 24.5f).south(50.5f, 31.5f, 47, 28), 2), PartPose.offsetAndRotation(0, 8.3f, -2, 0.48f, 0, 0));
        body.addOrReplaceChild("cube", GroupBuilder.create()
                .addBox(-1.8f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().down(56.5f, 0, 53, 3).north(11.5f, 55.5f, 8, 52).up(55.5f, 53, 52, 50).west(55, 49.5f, 52, 46).east(47, 55.5f, 44, 52).south(15.5f, 55.5f, 12, 52)), PartPose.offsetAndRotation(2, 8.3f, -2, 0.48f, 0, 0));
        body.addOrReplaceChild("cube_i0", GroupBuilder.create()
                .addBox(-1.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().down(56.5f, 23, 53, 26).north(33.5f, 55.5f, 30, 52).up(56.5f, 23, 53, 20).west(56, 10.5f, 53, 7).east(56, 6.5f, 53, 3).south(55.5f, 42.5f, 52, 39)), PartPose.offsetAndRotation(-2, 8.3f, -2, 0.48f, 0, 0));
        root.addOrReplaceChild("right_arm", GroupBuilder.create()
                .addBox(0, -10, -2, 4, 12, 4, new CubeUV().down(50, 31, 46, 35).north(28, 12, 24, 0).up(30, 50, 26, 46).west(24, 36, 20, 24).east(28, 24, 24, 12).south(20, 36, 16, 24))
        ...
        root.addOrReplaceChild("left_arm", GroupBuilder.create()
                .addBox(-4, -10, -2, 4, 12, 4, new CubeUV().down(16, 48, 12, 52).north(28, 36, 24, 24).up(12, 52, 8, 48).west(8, 40, 4, 28).east(4, 40, 0, 28).south(32, 12, 28, 0))
        ...
        right_leg.addOrReplaceChild("right_leg_thigh", GroupBuilder.create()
                .addBox(-2, -8, -2, 4, 8, 4, new CubeUV().down(44, 48, 40, 52).north(37, 19, 33, 11).up(34, 52, 30, 48).west(32, 41, 28, 33).east(37, 27, 33, 19).south(37, 35, 33, 27))
        ...
        left_foot.addOrReplaceChild("left_foot_i0", GroupBuilder.create()
                .addBox(-2.7f, -6, -3.5f, 4f, 2, 5, new CubeUV().down(44, 43, 40, 48).north(59, 50, 55, 48).up(36, 48, 32, 43).west(59, 15, 54, 13).east(59, 13, 54, 11).south(55, 57, 51, 55))
                .addBox(-2.7f, -6, -3.5f, 4f, 2, 5, new Vector3f(0.6f), new CubeUV().down(8, 16, 12, 20).north(8, 20, 12, 16).up(12, 20, 8, 16).west(12, 16, 8, 20).east(12, 20, 8, 16).south(12, 20, 8, 16), 4)
                .addMesh(new float[]{-1.6929f, -6.025f, -2, -1.4f, -6.025f, -2.7071f, -2.4f, -6.025f, -2.2929f, -2.1071f, -6.025f, -3, -1.9f, -6.025f, -2.5f, -1.4f, -6.025f, -2.2929f, -2.1071f, -6.025f, -2, -2.4f, -6.025f, -2.7071f, -1.6929f, -6.025f, -3, -0.4929f, -6.025f, -2, -0.2f, -6.025f, -2.7071f, -1.2f, -6.025f, -2.2929f, -0.9071f, -6.025f, -3, -0.7f, -6.025f, -2.5f, -0.2f, -6.025f, -2.2929f, -0.9071f, -6.025f, -2, -1.2f, -6.025f, -2.7071f, -0.4929f, -6.025f, -3, 0.7071f, -6.025f, -2, 1, -6.025f, -2.7071f, 0, -6.025f, -2.2929f, 0.2929f, -6.025f, -3, 0.5f, -6.025f, -2.5f, 1, -6.025f, -2.2929f, 0.2929f, -6.025f, -2, 0, -6.025f, -2.7071f, 0.7071f, -6.025f, -3, 0.915f, -6.025f, 1.025f, 0.725f, -6.025f, -1.325f, -2.315f, -6.025f, 1.025f, -2.125f, -6.025f, -1.325f, -0.7f, -6.025f, -0.3f, 1.2f, -6.025f, 0, -0.7f, -6.025f, 0.9f, -2.6f, -6.025f, 0, -0.7f, -6.025f, -1.8f}, new float[]{8, 32.7071f, 12, 1, 33, 11.7071f, 5, 33, 11.2929f, 4, 32.5f, 11.5f, 5, 33, 11.2929f, 0, 32.7071f, 11, 6, 32.2929f, 11, 4, 32.5f, 11.5f, 6, 32.2929f, 11, 2, 32f, 11.2929f, 7, 32, 11.7071f, 4, 32.5f, 11.5f, 7, 32, 11.7071f, 3, 32.2929f, 12, 8, 32.7071f, 12, 4, 32.5f, 11.5f, 17, 34.9571f, 49, 10, 35.25f, 48.7071f, 14, 35.25f, 48.2929f, 13, 34.75f, 48.5f, 14, 35.25f, 48.2929f, 9, 34.9571f, 48f, 15, 34.5429f, 48, 13, 34.75f, 48.5f, 15, 34.5429f, 48, 11, 34.25f, 48.2929f, 16, 34.25f, 48.707f, 13, 34.75f, 48.5f, 16, 34.25f, 48.7071f, 12, 34.5429f, 49, 17, 34.9571f, 49, 13, 34.75f, 48.5f, 26, 49.9571f, 40.5f, 19, 50.25f, 40.2071f, 23, 50.25f, 39.7929f, 22, 49.75f, 40f, 23, 50.25f, 39.7929f, 18, 49.9571f, 39.5f, 24, 49.5429f, 39.5f, 22, 49.75f, 40f, 24, 49.5429f, 39.5f, 20, 49.25f, 39.7929f, 25, 49.2501f, 40.2071f, 22, 49.75f, 40f, 25, 49.2501f, 40.2071f, 21, 49.5429f, 40.5f, 26, 49.9571f, 40.5f, 22, 49.75f, 40, 35, 54f, 46, 28, 55.425f, 45.525f, 32, 55.9f, 44.2f, 31, 54, 44.5f, 32, 55.9f, 44.2f, 27, 55.615f, 43.175f, 33, 54, 43.3f, 31, 54, 44.5f, 33, 54, 43.3f, 29, 52.385f, 43.175f, 34, 52.1f, 44.2f, 31, 54, 44.5f, 34, 52.1f, 44.2f, 30, 52.575f, 45.525f, 35, 54f, 46, 31, 54, 44.5f}, 9), PartPose.rotation(0, 0, 0.1309f));
        left_leg_.addOrReplaceChild("left_leg__i0", GroupBuilder.create()
                .addBox(-2, -5, -2, 4, 6, 4, new CubeUV().down(53, 35, 49, 39).north(4, 46, 0, 40).up(38, 53, 34, 49).west(28, 46, 24, 40).east(8, 46, 4, 40).south(24, 46, 20, 40))
                .addBox(-2, -5, -2, 4, 6, 4, new Vector3f(0.6f), new CubeUV().down(27, 46, 23, 50).north(0, 32, 4, 26).up(8, 50, 4, 46).west(4, 32, 8, 26).east(8, 32, 4, 26).south(4, 32, 0, 26), 4), PartPose.rotation(0.1309f, 0, 0));
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2, 0.3f, 1, 4, 2, 4, new CubeUV().down(53, 25, 49, 29).north(59, 36, 55, 34).up(53, 25, 49, 21).west(59, 48, 55, 46).east(59, 38, 55, 36).south(44, 57, 40, 55))
        ...
        left_leg.addOrReplaceChild("left_leg_thigh", GroupBuilder.create()
                .addBox(-2, -8, -2, 4, 8, 4, new CubeUV().down(53, 8, 49, 12).north(36, 43, 32, 35).up(53, 8, 49, 4).west(20, 44, 16, 36).east(12, 44, 8, 36).south(16, 44, 12, 36))
