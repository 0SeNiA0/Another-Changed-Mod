...
public class SnowLeopardFemaleModel<E extends LivingEntity> extends CustomHumanoidModel<E> {
    ...
    public static ModelDefinition bodyLayer() {
        ...
        head.addOrReplaceChild("right_ear", GroupBuilder.create()
                .addMesh(new float[]{-1, 5, -1, -1, 5, 4, -1, -2, -1, -1, -2, 4, 1, 5, -1, 1, 5, 4, 1, -2, -1, 1, -2, 4, -0.99f, 2, -1, -0.99f, 5, 2, -0.99f, 1.4284f, -0.2527f, 0.99f, 2, -1, 0.99f, 5, 2}, new float[]{3, 33, 19, 1, 33, 12, 0, 28, 12, 2, 28, 19, 6, 33, 26, 4, 33, 19, 5, 28, 19, 7, 28, 26, 0, 53, 33, 1, 53, 38, 5, 55, 38, 4, 55, 33, 2, 18, 55, 0, 18, 48, 4, 16, 48, 6, 16, 55, 7, 40, 56, 5, 40, 49, 1, 38, 49, 3, 38, 56, 8, 28, 40, 9, 28, 36, 12, 26, 36, 11, 26, 40}), PartPose.rotation(-0.4276f, -0.1745f, -0.5236f));
        head.addOrReplaceChild("left_ear", GroupBuilder.create()
                .addMesh(new float[]{1, 5, -1, 1, 5, 4, 1, -2, -1, 1, -2, 4, -1, 5, -1, -1, 5, 4, -1, -2, -1, -1, -2, 4, 0.99f, 2, -1, 0.99f, 5, 2, 0.99f, 1.4284f, -0.2527f, -0.99f, 2, -1, -0.99f, 5, 2}, new float[]{0, 33, 26, 1, 28, 26, 3, 28, 33, 2, 33, 33, 5, 37, 0, 4, 32, 0, 6, 32, 7, 7, 37, 7, 5, 34, 58, 1, 36, 58, 0, 36, 53, 4, 34, 53, 4, 2, 50, 0, 0, 50, 2, 0, 57, 6, 2, 57, 1, 4, 50, 5, 2, 50, 7, 2, 57, 3, 4, 57, 12, 38, 53, 9, 36, 53, 8, 36, 57, 11, 38, 57}), PartPose.rotation(-0.4276f, 0.1745f, 0.5236f));
        ...
        armor_body.addOrReplaceChild("cube", GroupBuilder.create()
                .addBox(-1.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().up(52.5f, 3, 49, 0).east(38, 28, 35, 24.5f).down(12, 16, 8, 20).north(12, 20, 8, 16).west(37, 28, 34, 24.5f).south(22.5f, 51.5f, 19, 48)), PartPose.offsetAndRotation(-2, 8.3f, -2, 27.5f, 0, 0));
        armor_body.addOrReplaceChild("cube_i0", GroupBuilder.create()
                .addBox(-1.8f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().up(38.5f, 51, 35, 48).east(37, 28, 34, 24.5f).down(12, 16, 8, 20).north(12, 20, 8, 16).west(37, 28, 34, 24.5f).south(50.5f, 31.5f, 47, 28)), PartPose.offsetAndRotation(2, 8.3f, -2, 27.5f, 0, 0));
        body.addOrReplaceChild("cube_i1", GroupBuilder.create()
                .addBox(-1.8f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().up(55.5f, 53, 52, 50).east(47, 55.5f, 44, 52).down(56.5f, 0, 53, 3).north(11.5f, 55.5f, 8, 52).west(55, 49.5f, 52, 46).south(15.5f, 55.5f, 12, 52)), PartPose.offsetAndRotation(2, 8.3f, -2, 27.5f, 0, 0));
        body.addOrReplaceChild("cube_i2", GroupBuilder.create()
                .addBox(-1.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().up(56.5f, 23, 53, 20).east(56, 6.5f, 53, 3).down(56.5f, 23, 53, 26).north(33.5f, 55.5f, 30, 52).west(56, 10.5f, 53, 7).south(55.5f, 42.5f, 52, 39)), PartPose.offsetAndRotation(-2, 8.3f, -2, 27.5f, 0, 0));
        ...
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(52, 46, 48, 42).east(30, 56, 26, 54).down(48, 48, 44, 52).north(26, 56, 22, 54).west(58, 32, 54, 30).south(58, 30, 54, 28)), PartPose.rotation(20, 0, 0));
        ...
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().up(53, 25, 49, 21).east(59, 38, 55, 36).down(53, 25, 49, 29).north(59, 36, 55, 34).west(59, 48, 55, 46).south(44, 57, 40, 55)), PartPose.rotation(20, 0, 0));
