...
public class SnowLeopardFemaleModel<E extends LivingEntity> extends CustomHumanoidModel<E> {
    ...
    public static ModelDefinition bodyLayer() {
        ...
        GroupDefinition head = root.addOrReplaceChild("head", GroupBuilder.create()
                ...
                .addBox(-2f, 1f, -6f, 4, 2, 2, new CubeUV().east(20, 46, 18, 44).west(32, 48, 30, 46).north(8, 56, 4, 54).south(58, 17, 54, 15).up(58, 19, 54, 17).down(22, 54, 18, 56))
        ...
        left_ear.addOrReplaceChild("left_ear_i0", GroupBuilder.create()
                .addMesh(new float[]{1, 5, -4, 1, 5, 1, 1, -2, -4, 1, -2, 1, -1, 5, -4, -1, 5, 1, -1, -2, -4, -1, -2, 1, 0.99f, 2, -4, 0.99f, 5, -1, 0.99f, 1.4284f, -3.2527f, -0.99f, 2, -4, -0.99f, 5, -1}, new float[]{0, 33, 26, 1, 28, 26, 3, 28, 33, 2, 33, 33, 5, 37, 0, 4, 32, 0, 6, 32, 7, 7, 37, 7, 5, 34, 58, 1, 36, 58, 0, 36, 53, 4, 34, 53, 4, 2, 50, 0, 0, 50, 2, 0, 57, 6, 2, 57, 1, 4, 50, 5, 2, 50, 7, 2, 57, 3, 4, 57, 12, 38, 53, 9, 36, 53, 8, 36, 57, 11, 38, 57}));
        ...
        armor_body.addOrReplaceChild("cube", GroupBuilder.create()
                .addBox(-1.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().east(38, 28, 35, 24.5f).west(37, 28, 34, 24.5f).north(12, 20, 8, 16).south(22.5f, 51.5f, 19, 48).up(52.5f, 3, 49, 0).down(12, 16, 8, 20))
                .addBox(2.2f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().east(37, 28, 34, 24.5f).west(37, 28, 34, 24.5f).north(12, 20, 8, 16).south(50.5f, 31.5f, 47, 28).up(38.5f, 51, 35, 48).down(12, 16, 8, 20)), PartPose.offsetAndRotation(-2, 8.3f, -2, 0.48f, 0, 0));
        body.addOrReplaceChild("cube_i0", GroupBuilder.create()
                .addBox(-1.8f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().east(47, 55.5f, 44, 52).west(55, 49.5f, 52, 46).north(11.5f, 55.5f, 8, 52).south(15.5f, 55.5f, 12, 52).up(55.5f, 53, 52, 50).down(56.5f, 0, 53, 3))
                .addBox(-5.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new CubeUV().east(56, 6.5f, 53, 3).west(56, 10.5f, 53, 7).north(33.5f, 55.5f, 30, 52).south(55.5f, 42.5f, 52, 39).up(56.5f, 23, 53, 20).down(56.5f, 23, 53, 26)), PartPose.offsetAndRotation(2, 8.3f, -2, 0.48f, 0, 0));
        ...
        right_foot.addOrReplaceChild("right_foot_i0", GroupBuilder.create()
                .addBox(-1.3f, -6f, -3.5f, 4f, 2, 5, new CubeUV().east(58, 28, 53, 26).west(57, 55, 52, 53).north(51, 56, 47, 54).south(59, 34, 55, 32).up(45, 33, 41, 28).down(46, 33, 42, 38))
                .addMesh(new float[]{-0.915f, -6.025f, 1.025f, -0.725f, -6.025f, -1.325f, 2.315f, -6.025f, 1.025f, 2.125f, -6.025f, -1.325f, 0.7f, -6.025f, -0.3f, -1.2f, -6.025f, 0, 0.7f, -6.025f, 0.9f, 2.6f, -6.025f, 0, 0.7f, -6.025f, -1.8f, -0.5f, -6.025f, -2.5f, -0.7071f, -6.025f, -2, -1, -6.025f, -2.2929f, -1, -6.025f, -2.7071f, -0.7071f, -6.025f, -3, -0.2929f, -6.025f, -3, -0f, -6.025f, -2.7071f, 0, -6.025f, -2.2929f, -0.2929f, -6.025f, -2, 0.7f, -6.025f, -2.5f, 0.4929f, -6.025f, -2, 0.2f, -6.025f, -2.2929f, 0.2f, -6.025f, -2.7071f, 0.4929f, -6.025f, -3, 0.9071f, -6.025f, -3, 1.2f, -6.025f, -2.7071f, 1.2f, -6.025f, -2.2929f, 0.9071f, -6.025f, -2, 1.9f, -6.025f, -2.5f, 1.6929f, -6.025f, -2, 1.4f, -6.025f, -2.2929f, 1.4f, -6.025f, -2.7071f, 1.6929f, -6.025f, -3, 2.1071f, -6.025f, -3, 2.4f, -6.025f, -2.7071f, 2.4f, -6.025f, -2.2929f, 2.1071f, -6.025f, -2}, new float[]{5, 40.1f, 53.2f, 1, 40.575f, 54.525f, 8, 42, 55, 4, 42, 53.5f, 6, 42, 52.3f, 0, 40.385f, 52.175f, 5, 40.1f, 53.2f, 4, 42, 53.5f, 7, 43.9f, 53.2f, 2, 43.615f, 52.175f, 6, 42, 52.3f, 4, 42, 53.5f, 8, 42, 55, 3, 43.425f, 54.525f, 7, 43.9f, 53.2f, 4, 42, 53.5f, 9, 55.75f, 55.5f, 12, 55.25f, 55.2929f, 11, 55.25f, 55.7071f, 10, 55.5429f, 56f, 9, 55.75f, 55.5f, 14, 55.9571f, 55, 13, 55.5428f, 55.0001f, 12, 55.25f, 55.2929f, 9, 55.75f, 55.5f, 16, 56.25f, 55.7071f, 15, 56.25f, 55.2929f, 14, 55.9571f, 55, 17, 55.957f, 56f, 16, 56.2499f, 55.7071f, 9, 55.75f, 55.5f, 10, 55.5429f, 56f, 18, 16.75f, 55.5f, 21, 16.25f, 55.2929f, 20, 16.25f, 55.7071f, 19, 16.5429f, 56, 18, 16.75f, 55.5f, 23, 16.9571f, 55, 22, 16.5429f, 55, 21, 16.25f, 55.2929f, 18, 16.75f, 55.5f, 25, 17.25f, 55.7071f, 24, 17.25f, 55.2929f, 23, 16.9571f, 55, 26, 16.9571f, 56, 25, 17.25f, 55.7071f, 18, 16.75f, 55.5f, 19, 16.5429f, 56f, 27, 50.75f, 40.5f, 30, 50.25f, 40.2929f, 29, 50.25f, 40.7071f, 28, 50.5429f, 41f, 27, 50.75f, 40.5f, 32, 50.9571f, 40, 31, 50.5429f, 40f, 30, 50.25f, 40.2929f, 27, 50.75f, 40.5f, 34, 51.25f, 40.7071f, 33, 51.25f, 40.2929f, 32, 50.9571f, 40f, 35, 50.957f, 41f, 34, 51.25f, 40.7071f, 27, 50.75f, 40.5f, 28, 50.5429f, 41f}), PartPose.rotation(0, 0, -0.1309f));
        ...
        right_leg_shin.addOrReplaceChild("right_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().east(30, 56, 26, 54).west(58, 32, 54, 30).north(26, 56, 22, 54).south(58, 30, 54, 28).up(52, 46, 48, 42).down(48, 48, 44, 52)), PartPose.rotation(0.3491f, 0, 0));
        ...
        left_foot.addOrReplaceChild("left_foot_i0", GroupBuilder.create()
                .addBox(-2.7f, -6f, -3.5f, 4f, 2, 5, new CubeUV().east(59, 13, 54, 11).west(59, 15, 54, 13).north(59, 50, 55, 48).south(55, 57, 51, 55).up(36, 48, 32, 43).down(44, 43, 40, 48))
                .addMesh(new float[]{0.915f, -6.025f, 1.025f, 0.725f, -6.025f, -1.325f, -2.315f, -6.025f, 1.025f, -2.125f, -6.025f, -1.325f, -0.7f, -6.025f, -0.3f, 1.2f, -6.025f, 0, -0.7f, -6.025f, 0.9f, -2.6f, -6.025f, 0, -0.7f, -6.025f, -1.8f, 0.5f, -6.025f, -2.5f, 0.7071f, -6.025f, -2, 1, -6.025f, -2.2929f, 1, -6.025f, -2.7071f, 0.7071f, -6.025f, -3, 0.2929f, -6.025f, -3, 0f, -6.025f, -2.7071f, 0, -6.025f, -2.2929f, 0.2929f, -6.025f, -2, -0.7f, -6.025f, -2.5f, -0.4929f, -6.025f, -2, -0.2f, -6.025f, -2.2929f, -0.2f, -6.025f, -2.7071f, -0.4929f, -6.025f, -3, -0.9071f, -6.025f, -3, -1.2f, -6.025f, -2.7071f, -1.2f, -6.025f, -2.2929f, -0.9071f, -6.025f, -2, -1.9f, -6.025f, -2.5f, -1.6929f, -6.025f, -2, -1.4f, -6.025f, -2.2929f, -1.4f, -6.025f, -2.7071f, -1.6929f, -6.025f, -3, -2.1071f, -6.025f, -3, -2.4f, -6.025f, -2.7071f, -2.4f, -6.025f, -2.2929f, -2.1071f, -6.025f, -2}, new float[]{8, 54, 46, 1, 55.425f, 45.525f, 5, 55.9f, 44.2f, 4, 54, 44.5f, 5, 55.9f, 44.2f, 0, 55.615f, 43.175f, 6, 54, 43.3f, 4, 54, 44.5f, 6, 54, 43.3f, 2, 52.385f, 43.175f, 7, 52.1f, 44.2f, 4, 54, 44.5f, 7, 52.1f, 44.2f, 3, 52.575f, 45.525f, 8, 54, 46, 4, 54, 44.5f, 11, 33f, 33.7071f, 12, 33f, 33.2929f, 9, 32.5f, 33.5f, 10, 32.7071f, 34f, 13, 32.7071f, 33.0001f, 14, 32.2928f, 33f, 9, 32.5f, 33.5f, 12, 33f, 33.2929f, 15, 32f, 33.2929f, 16, 32f, 33.7071f, 9, 32.5f, 33.5f, 14, 32.2929f, 33, 9, 32.5f, 33.5f, 16, 32f, 33.7071f, 17, 32.2929f, 34f, 10, 32.7071f, 34f, 20, 50.25f, 39.7071f, 21, 50.25f, 39.2929f, 18, 49.75f, 39.5f, 19, 49.9571f, 40f, 22, 49.9571f, 39f, 23, 49.5429f, 39f, 18, 49.75f, 39.5f, 21, 50.25f, 39.2929f, 24, 49.25f, 39.2929f, 25, 49.25f, 39.7071f, 18, 49.75f, 39.5f, 23, 49.5429f, 39, 18, 49.75f, 39.5f, 25, 49.25f, 39.7071f, 26, 49.5429f, 40f, 19, 49.9571f, 40f, 29, 51.25f, 33.7071f, 30, 51.25f, 33.2929f, 27, 50.75f, 33.5f, 28, 50.9571f, 34f, 31, 50.9571f, 33f, 32, 50.5429f, 33, 27, 50.75f, 33.5f, 30, 51.25f, 33.2929f, 33, 50.25f, 33.2929f, 34, 50.25f, 33.7071f, 27, 50.75f, 33.5f, 32, 50.5429f, 33f, 27, 50.75f, 33.5f, 34, 50.25f, 33.7071f, 35, 50.543f, 34f, 28, 50.9571f, 34f}), PartPose.rotation(0, 0, 0.1309f));
        ...
        left_leg_shin.addOrReplaceChild("left_leg_shin_i0", GroupBuilder.create()
                .addBox(-2f, 0.3f, 1f, 4, 2, 4, new CubeUV().east(59, 38, 55, 36).west(59, 48, 55, 46).north(59, 36, 55, 34).south(44, 57, 40, 55).up(53, 25, 49, 21).down(53, 25, 49, 29)), PartPose.rotation(0.3491f, 0, 0));
