...
public class SnowLeopardFemaleModel<E extends LivingEntity>  extends UniversalCustomModel<E> {
    ...
    public static ModelDefinition model(){
        ...
        armor_body.addOrReplaceChild("cube", GroupBuilder.create()
                .addBox(-3.7f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().south(22.5f, 51.5f, 19, 48).west(37, 28, 34, 24.5f).up(52.5f, 3, 49, 0).north(12, 20, 8, 16).east(38, 28, 35, 24.5f).down(12, 16, 8, 20), 2), PartPose.offset(-0f, 0, 0));
        armor_body.addOrReplaceChild("cube_i0", GroupBuilder.create()
                .addBox(0.2f, -1.8f, -1.5f, 3.5f, 3.5f, 3, new Vector3f(0.6f), new CubeUV().south(50.5f, 31.5f, 47, 28).west(37, 28, 34, 24.5f).up(38.5f, 51, 35, 48).north(12, 20, 8, 16).east(37, 28, 34, 24.5f).down(12, 16, 8, 20), 2), PartPose.offset(-0f, 0, 0));
