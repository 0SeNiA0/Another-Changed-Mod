...
import net.zaharenko424.a_changed.block.box.CardboardBox;
import net.zaharenko424.a_changed.block.box.SmallCardboardBox;
import net.zaharenko424.a_changed.block.box.TallBox;
import net.zaharenko424.a_changed.block.box.TallCardboardBox;
import net.zaharenko424.a_changed.block.door.*;
import net.zaharenko424.a_changed.block.machine.*;
...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Disc> DISC = BLOCKS.register("disc", ()-> new Disc(BlockBehaviour.Properties.of().sound(SoundType.STONE).strength(.4f).noLootTable()));
    ...
    public static final DeferredBlock<FloorCircle> LIME_FLOOR_CIRCLE = BLOCKS.register("lime_floor_circle", ()-> new FloorCircle(BlockBehaviour.Properties.of().noOcclusion().instabreak()));
    ...
    public static final DeferredBlock<PaperStack> PAPER_STACK = BLOCKS.register("paper_stack", ()-> new PaperStack(BlockBehaviour.Properties.of().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOL).mapColor(DyeColor.WHITE)));
    public static final DeferredBlock<PileOfOranges> PILE_OF_ORANGES = BLOCKS.register("pile_of_oranges", ()-> new PileOfOranges(BlockBehaviour.Properties.of().noLootTable().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOL).mapColor(DyeColor.ORANGE)));
    ...
    public static final DeferredBlock<FloorCircle> RED_FLOOR_CIRCLE = BLOCKS.register("red_floor_circle", ()-> new FloorCircle(BlockBehaviour.Properties.of().noOcclusion().instabreak()));
    public static final DeferredBlock<RotatingChair> ROTATING_CHAIR = BLOCKS.register("rotating_chair", ()-> new RotatingChair(decorProperties().pushReaction(PushReaction.DESTROY).mapColor(DyeColor.BLACK)));
    public static final DeferredBlock<Scanner> SCANNER = BLOCKS.register("scanner", ()-> new Scanner(softMetal().mapColor(DyeColor.ORANGE).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<SmartSewageSystem> SMART_SEWAGE_SYSTEM = BLOCKS.register("smart_sewage_system", ()-> new SmartSewageSystem(decorProperties().mapColor(DyeColor.GRAY)));
    public static final DeferredBlock<Block> STRIPED_LIGHT_BLUE_LAB_BLOCK = BLOCKS.registerSimpleBlock("striped_light_blue_lab_block", decorProperties().mapColor(DyeColor.LIGHT_BLUE));
    ...
    public static final DeferredBlock<Table> TABLE = BLOCKS.register("table", ()-> new Table(decorProperties().mapColor(DyeColor.GRAY)));
    ...
    public static final DeferredBlock<TVScreen> TV_SCREEN = BLOCKS.register("tv_screen", ()-> new TVScreen(decorProperties().mapColor(DyeColor.BLACK)));
    public static final DeferredBlock<VentDuct> VENT_DUCT = BLOCKS.register("vent_duct", ()-> new VentDuct(softMetal().mapColor(DyeColor.GRAY).noOcclusion()));
