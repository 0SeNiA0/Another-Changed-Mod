...
public class WidgetHelper {
    ...
    public static void blit(ResourceLocation tex, PoseStack stack, float x, float y, float z, float width, float height, float uOffset, float vOffset, float uWidth, float vHeight, float texWidth, float texHeight){
        ...
        bufferbuilder.addVertex(matrix4f, x, y, z).setUv(minU, minV);
        bufferbuilder.addVertex(matrix4f, x, y + height, z).setUv(minU, maxV);
        bufferbuilder.addVertex(matrix4f, x + width, y + height, z).setUv(maxU, maxV);
        bufferbuilder.addVertex(matrix4f, x + width, y, z).setUv(maxU, minV);
